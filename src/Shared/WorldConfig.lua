...
WorldConfig.Scale = {
    ...
    TreeHeight = 32, -- chunky cube tree (tall: towers over the bases, with per-tree scale variation)
...
WorldConfig.MeadowFoliage = {
    ...
    TreeClusters = 58, -- the HERO: tight clusters of 2-3 clean trees, EVEN sunflower spread -> dense forest
    PineTrees = 42, -- tall conifers thickening the canopy, interleaved into the same even spread
    Rocks = 26, -- mossy colliding rocks (accents), away from the spawn cone
