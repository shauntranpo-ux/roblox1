...
safeMount("Menu", function()
    ...
    EdgeTabs.add("Right", "⭐", "Rebirth", function()
    ...
    -- LEFT rail: social / rewards / events tabs.
    ...
    EdgeTabs.add("Left", "📨", "Invite", function()
        PanelManager.open("Referral")
    end)
    EdgeTabs.add("Left", "💎", "Exclusives", function()
        PanelManager.open("Exclusives")
    end)
    EdgeTabs.add("Left", "🏆", "Seasons", function()
        PanelManager.open("Seasons")
    end)
    EdgeTabs.add("Left", "🎉", "Events", function()
        PanelManager.open("Events")
    end)
    EdgeTabs.add("Left", "🚩", "Report", function()
        PanelManager.open("Report")
    end)
    -- MENU stays for utility/basics only.
